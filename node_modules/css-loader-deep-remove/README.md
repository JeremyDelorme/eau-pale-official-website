...
# css-loader-deep-remove
基于css-loader去除/deep/兼容chrome89样式出错问题
...
```console
npm install --save-dev css-loader-deep-remove
```
...
module.exports = {
  module: {
    rules: [
      {
        test: /\.css$/,
        use: ['style-loader', 'css-loader-deep-remove'],
      },
    ],
  },
};
...
module.exports = {
  module: {
    rules: [
      {
        test: /\.css$/,
        use: ['to-string-loader', 'css-loader-deep-remove'],
      },
    ],
  },
};
